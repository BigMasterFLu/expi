...
amount_spent = float(input("How much money did you spend? "))
money_after_spending = five_day_pay - amount_spent
...
number3 = int(input("Enter the third whole number: "))
...
user_age = 2026 - user_birth_year
favorite_number_times_age = user_favorite_number * user_age
